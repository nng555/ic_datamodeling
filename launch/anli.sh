 ...
 python3 eval_dataset.py dataset=facebook/anli num_shards=32 shard=$(seq -s, 0 1 31) tags=anli hydra.launcher.qos=scavenger hydra.launcher.time=2880 hydra.launcher.partition=rtx6000 -m
