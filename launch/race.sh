 ...
 #python3 eval_dataset.py dataset=ehovy/race subset=high num_shards=32 shard=$(seq -s, 0 1 31) tags=race hydra.launcher.qos=scavenger hydra.launcher.time=2880 -m
